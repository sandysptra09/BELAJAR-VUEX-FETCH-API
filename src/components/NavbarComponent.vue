    ...
    <div>
        ...
        <header class="header sticky top-0 bg-white shadow-md flex items-center justify-between px-8 py-02">
            ...
            <h1 class="w-3/12">
                <a href="">
                    <h2
                        class="text-3xl font-semibold tracking-tight border-green-500 border-opacity-0 hover:border-opacity-100 hover:text-green-500">
                        Sansanpedia.</h2>
                </a>
            </h1>
            ...
            <div class="w-3/12 flex justify-end">
                <a href="">
                    <svg class="h-8 p-1 hover:text-green-500 duration-200 svg-inline--fa fa-search fa-w-16 fa-9x"
                ...
                <a href="">
                    <svg class="h-8 p-1 hover:text-green-500 duration-200 svg-inline--fa fa-shopping-cart fa-w-18 fa-7x"
